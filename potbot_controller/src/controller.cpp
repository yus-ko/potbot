...
ControllerClass::ControllerClass(tf2_ros::Buffer& tf, const std::string& name) : tf_buffer_(tf)
{
	ros::NodeHandle n("~");
    ...
    dynamic_reconfigure::Server<potbot_msgs::ControllerConfig>::CallbackType cb = boost::bind(&ControllerClass::__param_callback, this, _1, _2);
