...
class PotentialMethodClass{
    ...
    private:
        ...
        autonomous_mobile_robot_2022::ClassificationVelocityData pcl_cluster;
    ...
    public:
        ...
        void cluster_callback(const autonomous_mobile_robot_2022::ClassificationVelocityData& msg);
        void get_topic();
