...
//#include <potbot/measurementVelocityConfig.h>
...
class measurementVelocity{
    private:
        ...
        potbot::ClassificationData curClstr,prvClstr;
        potbot::ImageMatchingData matchData;
        //送信データ
		ros::NodeHandle nhPub;
        ros::Publisher pub;
    	potbot::ClassificationVelocityData cvd;//速度データ付きのクラスタデータ
        //クラスタマップ
        ...
        // dynamic_reconfigure::Server<potbot::measurementVelocityConfig> server;
        // dynamic_reconfigure::Server<potbot::measurementVelocityConfig>::CallbackType f;
        //
    public:
        //in constracter.cpp
        ...
        //in property.cpp
        void setLaunchParam();
        //void configCallback(potbot::measurementVelocityConfig &config, uint32_t level);
        //セット：内部パラメータの書き込み
        ...
        void cluster_callback(const potbot::ClassificationData::ConstPtr& msg);
        // void subscribeImageMatchingData();//データ受信
        void matching_callback(const potbot::ImageMatchingData::ConstPtr& msg);
        //--マッチング
