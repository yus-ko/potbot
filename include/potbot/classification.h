...
// #include <potbot/CompressedSensorData.h>
...
//#include <potbot/classificationConfig.h>
//クラスの定義
class classificationClass{
    private:
        ...
        potbot::SensorMapData smdCamera, smdLRF;
        //送信データ
		ros::NodeHandle nhPub;
        ros::Publisher pub;
        potbot::ClassificationData cd;
        //クラスタリング処理
        // std::vector<int> mapIndex;//
    	std::vector<int> winIndex;//基準点（コア点）から参照値
        // potbot::CompressedSensorData compCamData;
        //--カメラパラメータ
        ...
        //dynamic_reconfigure::Server<potbot::classificationConfig> server;
        //dynamic_reconfigure::Server<potbot::classificationConfig>::CallbackType f;
    public:
        //in constracter.cpp
        ...
        void cameraMap_callback(const potbot::SensorMapData::ConstPtr& msg);
        void subscribeSensorDataLRF();//データ受信
        void laserMap_callback(const potbot::SensorMapData::ConstPtr& msg);
        //--rqt_reconfigureからの読み込み
        //void configCallback(potbot::classificationConfig &config, uint32_t level);
        //--クラスタリング
