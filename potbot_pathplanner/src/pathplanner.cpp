...
PathPlanningClass::PathPlanningClass(tf2_ros::Buffer& tf, const std::string& name) : tf_buffer_(tf)
{
    ...
    dynamic_reconfigure::Server<potbot_msgs::PathPlanningConfig>::CallbackType cb = boost::bind(&PathPlanningClass::__param_callback, this, _1, _2);
