...
namespace potbot_pathplanner
{
    ...
    LocalPathPlanner::LocalPathPlanner(tf2_ros::Buffer& tf, const std::string& name) : tf_buffer_(tf)
    {
        ...
        sub_goal_ 		= nhSub.subscribe("goal",           1, &LocalPathPlanner::__goal_callback, this);
    ...
    void LocalPathPlanner::__goal_callback(const geometry_msgs::PoseStamped& msg)
    {
        goal_ = msg;
    ...
    void LocalPathPlanner::__local_map_callback(const nav_msgs::OccupancyGrid& msg)
    {
        local_map_ = msg;
    ...
    void LocalPathPlanner::__segment_callback(const visualization_msgs::MarkerArray& msg)
    {
        obstacles_ = msg;
    }

    void LocalPathPlanner::__state_callback(const potbot_msgs::StateArray& msg)
    {
        obstacle_state_ = msg;
    }

    void LocalPathPlanner::__create_path_callback(const std_msgs::Empty& msg)
    {
        __create_Path();
    }
    ...
    int LocalPathPlanner::__create_PotentialField()
    {
    ...
    void LocalPathPlanner::__create_Path()
    {
    ...
    bool LocalPathPlanner::__PathCollision()
    {
