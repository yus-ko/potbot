...
PointCloudClass::PointCloudClass()
{
	...
	//publisher
    pubpc= nhPub1.advertise<autonomous_mobile_robot_2022::PointCloudData>("Extracted_PointCloud", 1);
	pubpc1= nhPub1.advertise<autonomous_mobile_robot_2022::PointCloudData>("Created_PointCloud", 1);
	pub_clus= nhPub1.advertise<autonomous_mobile_robot_2022::ClusterData>("Clustering_PointCloud", 1);
	// lanchファイルの読み込み
	setLaunchParam();
