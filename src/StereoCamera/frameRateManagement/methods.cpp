...
void managementClass::callback(const potbot::synchronizedImage::ConstPtr& imageMsg){
    //重複チェック
...
void managementClass::checkDuplication(const potbot::synchronizedImage::ConstPtr& imageMsg){//データ送信
