...
void classificationClass::cameraMap_callback(const potbot::SensorMapData::ConstPtr& msg)
{
    //データをコピー
    smdCamera = *msg;
	//move manage method
...
void classificationClass::laserMap_callback(const potbot::SensorMapData::ConstPtr& msg)
{
    //データをコピー
