...
// }
void measurementVelocity::cluster_callback(const potbot::ClassificationData::ConstPtr& msg)
{
    //データをコピー
...
// }
void measurementVelocity::matching_callback(const potbot::ImageMatchingData::ConstPtr& msg)
{
    //データをコピー
